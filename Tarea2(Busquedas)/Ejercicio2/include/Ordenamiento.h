...
class Ordenamiento {
public:
    static void ordenar(T[], int, bool(*)(T,T), void(*)(T[],int,bool(*)(T,T)));
...
template <class T>
void Ordenamiento<T>::ordenar(T v[], int n,bool compara (T, T), void tipoOrdenamiento(T[],int,bool(*)(T,T)))
{
    tipoOrdenamiento(v,n,compara);
}
